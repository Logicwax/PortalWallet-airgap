#!/usr/bin/env bash
# Build the portalwallet Electron app and package it into a .deb inside the pinned
...
mkdir -p "$OUT"
DEB="$OUT/portalwallet_${VERSION}_amd64.deb"
cp "$WORK/app/out/make/deb/x64/portalwallet_${VERSION}_amd64.deb" "$DEB"
